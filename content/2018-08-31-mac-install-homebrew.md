...
![安裝 Homebrew](/images/posts/mac-install-homebrew/1-install-homebrew-on-mac.png)
...
![export 檢查環境變數](/images/posts/mac-install-homebrew/2-check-export-env.png)

則編輯 `~/.bash_profile`，如下圖：

![編輯 edit_profile](/images/posts/mac-install-homebrew/3-edit-bash-profile.png)

完成後，重新開啟 Terminal 應用程式，再次透過 export 檢查，輸入了 `/usr/local/sbin` ：

![查看環境變數](/images/posts/mac-install-homebrew/5-test-brew.png)
...
如診斷：
![測試 brew 指令](/images/posts/mac-install-homebrew/5-test-brew.png)
...
![安裝 wget](/images/posts/mac-install-homebrew/6-ex-install-wget.png)
