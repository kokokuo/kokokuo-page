...
![安裝 XCode Tool](/images/posts/install-python2-on-mac/1-Install-XCode-Tool.png)
...
![安裝 Homebrew](/images/posts/install-python2-on-mac/2-install-homebrew.png)
...
![安裝完訊息](/images/posts/install-python2-on-mac/3-install-python2.png)

安裝完後 Homebrew 會自動為放在 Cellar 的 Python@2 在 Mac 的 `/usr/local/opt` 與 `/usr/local/bin` 分別建置 link 檔案，如下為 `/usr/local/opt`：

![安裝完路徑/usr/local/opt](/images/posts/install-python2-on-mac/4-python2-installed-location-1.png)

`/usr/local/bin` 也有：

![安裝完路徑/usr/local/bin](/images/posts/install-python2-on-mac/4-python2-installed-location-2.png)
...
![安裝完後的 Python 指令](/images/posts/install-python2-on-mac/5-python2-installed-command.png)
